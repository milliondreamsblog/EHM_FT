  ...
  const sections = [
    {
      ...
      queries: [
        ...
        },
        {
          ...
          label: "Query 2",
          question:
            "Is there a designated project manager responsible for oversight and coordination?",
        },
        {
          id: "mitigation",
          label: "Mitigation",
          question:
            "What mitigation measures are planned in case the project deviates from its objectives?",
        },
      ],
    },
    {
      ...
      queries: [
        {
          id: "finance1",
          label: "Projects Payback Period & Percent of funding",
          question:
            "Is the project financially viable considering the payback period and funding percentage?",
        },
        {
          id: "finance2",
          label: "Mitigation",
          question:
            "What financial mitigation strategies are planned if funding is delayed?",
        },
      ],
    },
    {
      ...
      queries: [
        {
          ...
          label: "General",
          question:
            "Does pursuing this project create significant opportunity costs compared to alternatives?",
        },
      ],
    },
  ];
