...
const Testimonials = () => {
  ...
  return (
    <div className="">
      ...
      <div className="text-center mb-6 sm:mb-8 md:mb-12 py-4 sm:py-6 md:py-8 px-4">
        ...
        <div className="w-20 sm:w-24 md:w-32 h-1 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full mx-auto"></div>
      </div>

      {/* Cards Section - Responsive */}
      <div className="relative mt-5 bg-black overflow-hidden rounded-tl-2xl rounded-bl-2xl"
        style={{ 
          height: 'auto', 
          minHeight: '400px', 
      ...
      >
        ...
        <div className="relative z-10 w-full h-full px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 md:py-10 flex flex-col text-white">
          <div className="text-left mb-4 sm:mb-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Market Making Transactions</h2>
          ...
          <div className="relative flex flex-col h-full justify-between w-full">
            ...
            >
              {cardData.map((card, idx) => (
                <div
                  key={idx}
                  className="relative rounded-xl shadow-md min-w-[250px] sm:min-w-[280px] md:min-w-[300px] max-w-[280px] sm:max-w-[300px] md:max-w-[320px] h-48 sm:h-52 md:h-60 flex-shrink-0 overflow-hidden scroll-snap-start"
                >
                  <img
                    src={card.logo}
                    alt={`Project ${idx}`}
          ...
          <div className="absolute bottom-2 sm:bottom-3 left-12 sm:left-16 md:left-20 transform -translate-x-1/2 flex gap-2 sm:gap-3">
            <button
              onClick={scrollLeft}
              className="bg-white text-black p-1.5 sm:p-2 rounded-full shadow-md hover:bg-gray-100"
            >
      ...
      {/* Work Beyond Section - Responsive */}
      <div className="bg-gray-100 p-4 sm:p-6 md:p-8 font-sans">
        <div className="max-w-6xl mx-auto bg-white rounded-lg p-4 sm:p-5 md:p-6">
